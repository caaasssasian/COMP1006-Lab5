...
INSERT INTO teams (teamName, captainName, phone, email) VALUES
  ('Mustangs', 'Roger Zurita', '780-555-1234', 'roger.zurita@gmail.com'),
  ('Fireflies', 'Emily Weingarten', '905-555-1234', 'eweingarten@rogers.com'),
  ('Sno Devils', 'Kim Robinson', '416-555-0000', 'kr100@live.ca'),
  ('Blizzard', 'James Park', '705-555-3498', 'james_p@hotmail.com');
...
INSERT INTO racers (racerName, age, sex, phoneNum, teamId) VALUES
  ...
  ('Dave Bender', 10, 'M', '604-612-2833', 11),
  ('Chris Hernandez', 9, 'M', '613-449-2313', 11),
  ('John Rickard', 7, 'M', '613-542-4426', 11),
  ('Viola Andrews', 8, 'M', '905-574-3137', 11),
  ('Maggie Bryne', 7, 'F', '780-542-6676', 21),
  ('Brett Burns', 7, 'M', '902-442-3717', 21),
  ('Amanda Garcia', 8, 'F', '519-457-4900', 21),
  ('Steve Foley', 9, 'F', '403-878-2691', 21),
  ('Andrea Yez', 8, 'F', '450-660-2828', 21),
  ('Sue Sterling', 9, 'F', '604-823-0393', 21),
  ('Neil Naraine', 9, 'F', '250-727-6226', 21)
  ('Dave Hopkins', 10, 'M', '604-612-2833', 31),
  ('Chris Brasz', 10, 'M', '613-449-2313', 31),
  ('Brent Short', 7, 'M', '613-542-4426', 31),
  ('Casey Matthews', 8, 'M', '905-574-3137', 31),
  ('Lauren Matthews', 10, 'F', '905-574-3137', 31);

INSERT INTO races (raceDay, resortId, racerId, raceTime, runNum) VALUES
  ('2012-01-15', 1, 231, '1.42', 1),
  ('2012-01-15', 1, 241, '1.53', 2),
  ('2012-01-15', 1, 251, '1.32', 1),
  ('2012-01-15', 1, 261, '1.29', 2),
  ('2012-01-15', 1, 271, '1.41', 1),
  ('2012-01-15', 1, 281, '1.51', 2),
  ('2012-01-15', 1, 291, '1.59', 1);
